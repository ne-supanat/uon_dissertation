...
def main():
    ...
    ta_codes_txt_path = folder_path + "/thematic_analysis_codes.txt"
    ta_codes_csv_path = folder_path + "/thematic_analysis_codes.csv"
    ...
    profiles_path = folder_path + "/profiles.txt"
    ...
    scenario_questions_path = folder_path + "/scenario_questions.txt"
    scenario_ground_truth_path = folder_path + "/scenario_ground_truth.txt"

    scenario_answers_path = folder_path + "/scenario_answers.csv"
    scenario_scores_path = folder_path + "/scenario_scores.csv"
